...
{
    private static readonly Lazy<IReadOnlyDictionary<string, IconDefinition>> IconsLoader = new(() => Load("duotone"));

    public static IReadOnlyList<string> Suffixes { get; } = new[] { "duotone", "duotone-line", "fill", "light", "regular" };
