...
{
    private static readonly Lazy<IReadOnlyDictionary<string, IconDefinition>> IconsLoader = new(() => Load("bold"));

    public static IReadOnlyList<string> Suffixes { get; } = new[] { "bold", "bold-duotone", "broken", "duotone", "linear", "outline" };
