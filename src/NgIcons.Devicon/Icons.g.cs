...
{
    private static readonly Lazy<IReadOnlyDictionary<string, IconDefinition>> IconsLoader = new(() => Load("line"));

    public static IReadOnlyList<string> Suffixes { get; } = new[] { "line", "original", "plain" };
