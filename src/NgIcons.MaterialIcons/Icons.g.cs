...
{
    private static readonly Lazy<IReadOnlyDictionary<string, IconDefinition>> IconsLoader = new(() => Load("baseline"));

    public static IReadOnlyList<string> Suffixes { get; } = new[] { "baseline", "outline", "round", "sharp" };
