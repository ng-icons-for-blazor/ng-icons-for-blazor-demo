...
{
    private static readonly Lazy<IReadOnlyDictionary<string, IconDefinition>> IconsLoader = new(() => Load("brands"));

    public static IReadOnlyList<string> Suffixes { get; } = new[] { "brands", "regular", "solid" };
