...
{
    private static readonly Lazy<IReadOnlyDictionary<string, IconDefinition>> IconsLoader = new(() => Load("micro"));

    public static IReadOnlyList<string> Suffixes { get; } = new[] { "micro", "mini", "outline", "solid" };
