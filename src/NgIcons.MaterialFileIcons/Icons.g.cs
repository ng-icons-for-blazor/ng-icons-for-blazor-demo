...
{
    private static readonly Lazy<IReadOnlyDictionary<string, IconDefinition>> IconsLoader = new(() => Load("colored"));

    public static IReadOnlyList<string> Suffixes { get; } = new[] { "colored", "uncolored" };
