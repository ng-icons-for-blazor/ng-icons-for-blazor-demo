...
{
    private static readonly Lazy<IReadOnlyDictionary<string, IconDefinition>> IconsLoader = new(() => Load("outline"));

    public static IReadOnlyList<string> Suffixes { get; } = new[] { "outline", "round", "sharp" };
