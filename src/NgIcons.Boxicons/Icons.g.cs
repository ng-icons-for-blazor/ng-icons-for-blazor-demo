...
{
    private static readonly Lazy<IReadOnlyDictionary<string, IconDefinition>> IconsLoader = new(() => Load("logos"));

    public static IReadOnlyList<string> Suffixes { get; } = new[] { "logos", "regular", "solid" };
